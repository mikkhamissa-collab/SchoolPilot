      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="px-4 py-2.5 rounded-xl bg-surface border border-border text-text-secondary hover:text-white text-sm transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all border whitespace-nowrap ${
              courseFilter === "all"
                ...
                : "bg-surface text-text-secondary hover:text-white border-border"
            }`}
          >
            All Classes
          </button>
      ...
      {movingTask && (
        <div className="p-3 rounded-xl bg-accent/10 border border-accent/20 text-accent text-sm flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs px-3 py-1 rounded-lg bg-surface border border-border text-text-secondary hover:text-white"
          >
            Cancel
          </button>
        </div>
                  ...
                  {addingToDay === day.key ? (
                    <div className="space-y-1.5">
                      <input
                        ...
                        className="w-full px-2 py-1.5 rounded-lg bg-bg border border-border text-white text-xs placeholder:text-muted focus:outline-none focus:border-accent"
                      />
                      <select
                        value={newTaskCourse}
